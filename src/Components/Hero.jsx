...
const Hero = () => {
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 items-center justify-center p-6">
      <div className="">
        <h4 className="text-[#ed3849] mb-4">
          UP TO 20% DISCOUNT ON
        </h4>
        <h1 className="text-6xl lg:text-8xl font-bold playfair">Girl's Fashion</h1>
